...
const Rwr = () => {
    ...
    if (isUserData && userData.number !== "" && userData.number !== -1) {
        ...
        return (
                ...
                <img alt='google logo' className='googleImg'/>
                <h2 className='positHeading'>Hey My!</h2>
                ...
                <p className='notification'>Google sent a notification to your phone Open the Gmail
